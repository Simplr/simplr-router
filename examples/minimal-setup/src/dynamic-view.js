...
export class DynamicView extends LitElement {
    ...
    constructor() {
        super();
        this.title = "Welcome to the dynamic view";
    }
    ...
    render() {
      ...
      <main>
        ...
        <h1>${this.title}</h1>
        <p>The parameter from the URL is bound to the "id" property of this view</p>
        <p>The current value is: ${this.id}</p>
...
customElements.define("dynamic-view", DynamicView);

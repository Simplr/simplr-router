...
const getEventPath = (event) => event.path || (event.composedPath && event.composedPath());

class ForwardsTransitionObject {
    constructor(view) {
        this.view = view;
...
class BackwardsTransitionObject {
    constructor(view) {
        this.view = view;
        this.backwards = true;
        this.initialView = false;
...
const updateHistory = (path) => window.history.pushState(null, '', path);
...
class SimplrRouterContainer extends HTMLElement {
...
const routes = [
    {
        ...
        import: () => import('./root-view-31e364db.js'),
        name: 'Home',
    },
    {
        path: '/getting-started',
        component: 'router-docs-getting-started',
        import: () => import('./getting-started-688ec131.js'),
        name: 'Getting started',
    },
    {
        path: '/api-description',
        component: 'router-docs-api-description',
        import: () => import('./api-description-8966e22f.js'),
        name: 'API description',
    },
    {
        path: '/recipes',
        component: 'router-docs-recipes',
        import: () => import('./docs-recipes-3ac9d87f.js'),
        name: 'Recipes',
        routes: [
            {
                path: '/sub-routes',
                component: 'router-docs-sub-routes',
                import: () => import('./docs-sub-routes-44f4e3e9.js'),
                name: 'Sub routes',
            },
            {
                path: '/guards',
                component: 'router-docs-guards',
                import: () => import('./docs-guard-2f2fdb58.js'),
                name: 'Guards',
            },
            {
                path: '/error-pages',
                component: 'router-docs-error-pages',
                import: () => import('./docs-error-pages-b070c6e1.js'),
                name: 'Error pages',
            },
            {
                path: '/code-splitting',
                component: 'router-docs-code-splitting',
                import: () => import('./docs-code-splitting-f2418deb.js'),
                name: 'Code splitting',
            },
            {
                path: '/slots',
                component: 'router-docs-slots',
                import: () => import('./docs-slots-0b940804.js'),
                name: 'Slots',
            },
            {
                path: '/transition-styling',
                component: 'router-docs-transition-styling',
                import: () => import('./docs-transition-styling-f769362d.js'),
                name: 'Transition styling',
            },
            {
                path: '/middleware',
                component: 'router-docs-middleware',
                import: () => import('./docs-middleware-7be24d8f.js'),
                name: 'Middleware',
            },
        ],
    },
    {
        ...
        import: () => import('./quick-start-b0e1dcc2.js'),
        name: 'Quick start',
    },
];
...
export { LitElement as L, NavigationDrawer as N, css as c, html as h };

    ...
    _addWrapperAnimations(sheet, router) {
        ...
        switch (router.transitionDirection) {
            case TransitionDirection.RIGHT:
                cssRule = `-webkit-transform: translateX(${window.outerWidth}px); transform: translateX(${window.outerWidth}px);`;
                oppositeCssRule = `-webkit-transform: translateX(-${window.outerWidth}px); transform: translateX(-${window.outerWidth}px);`;
                break;
            case TransitionDirection.BOTTOM:
                cssRule = `-webkit-transform: translateY(${window.outerHeight}px); transform: translateY(${window.outerHeight}px);`;
                oppositeCssRule = `-webkit-transform: translateY(-${window.outerHeight}px); transform: translateY(-${window.outerHeight}px);`;
                break;
            ...
            default:
                ...
                oppositeCssRule = `left: -${window.outerWidth}px`;
                break;
        }
        sheet.insertRule(

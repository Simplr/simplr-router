...
export class Router {
    ...
    _pushNewViewIntoDom(component, viewObject) {
        if (viewObject.nestedParent && (this.activeViewObject?.nestedParent === viewObject.nestedParent || this._activeViewIsNestedParentOf(viewObject))) {
     ...
     * @param {SimplrRouterNavigationData} viewObject
     */
    _handleNestedView(component, viewObject) {
    ...
    handleUrlPathing() {
        this.changeView(InitialTransitionObject.from(this._getViewFromUrl()));
    }

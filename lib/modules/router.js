...
export default class Router {
    ...
    _handleRedirect(viewObject) {
        const redirectParam = viewObject.view.redirect;
        let redirectRoute;
        ...
        for (let route of this.dynamicRoutes) {
            ...
            if (dynamicRoute.pattern) {
                ...
                for (const pattern of Object.entries(dynamicRoute.pattern)) {
                    ...
                    const urlParameterIsValid = paramMatchesPattern && paramMatchesPattern[0] === paramMatchesPattern.input

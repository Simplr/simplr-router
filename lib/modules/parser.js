 ...
 * TODO: Consider having them as some sort of maps/weakmaps for faster lookup
    * e.g. match with the route parts
 * */
export class Parser {
    /**
    ...
    /**
     * @param {import("../types/SimplrRoute").SimplrRoute[]} routes
     */
    parseRoutes(routes) {
        if (!routes) {
            throw Error(
    ...
    /**
     * @param {import("../types/SimplrRoute").SimplrRoute[]} routes
     * @param {import("../types/Shared").SimplrRouterNavigationData[]} staticRoutes
     * @param {import("../types/Shared").SimplrRouterNavigationData[]} dynamicRoutes
     * @param {import("../types/Shared").SimplrRouterNavigationData} [parent]
     * @param {boolean} [isNested = false]
     */
    _iterateRoutes(routes, staticRoutes, dynamicRoutes, parent, isNested = false) {
        let index = null;
        for (let route of routes) {
            const navData = /** @type import("../types/Shared").SimplrRouterNavigationData */ ({ ...route, params: {} });
    ...
    /**
     * @param {import("../types/Shared").SimplrRouterNavigationData} routeObject
